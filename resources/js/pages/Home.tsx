    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white">
                ...
                {/* ヒーローセクション */}
                <header className="py-20 px-6 flex flex-col items-center text-center bg-gradient-to-r from-blue-50 to-indigo-50">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 w-full max-w-2xl">
                        ...
                        <div className="flex-1 min-w-[250px] bg-blue-600 p-6 rounded-2xl shadow-md text-white">
